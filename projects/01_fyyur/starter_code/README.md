...
3. Fill out every `TODO` section throughout the codebase. We suggest going in order of the following:
  ...
  Schema for artists (ARTIST):
    id INTEGER PRIMARY KEY, --> available
    name VARCHAR NOT NULL, --> available
    city VARCHAR NOT NULL, --> available
    state VARCHAR NOT NULL, --> available
    phone VARCHAR, --> available
    genre VARCHAR, --> available but not 3NF (not even 1NF)
    image_link VARCHAR, --> available
    facebook_link VARCHAR, --> available
    seeking BOOLEAN NOT NULL, --> TBD
    seeking_description VARCHAR --> TBD
   
  Schema for venues (VENUE):
    id INTEGER PRIMARY KEY, --> available
    name VARCHAR NOT NULL, --> available
    city VARCHAR NOT NULL, --> available
    state VARCHAR NOT NULL, --> available
    address VARCHAR, --> available
    phone VARCHAR, --> available
    image_link VARCHAR, --> available
    facebook_link VARCHAR, --> available
    seeking BOOLEAN NOT NULL, --> TBD
  ...
  Schema for shows (SHOW): --> TBD completely
