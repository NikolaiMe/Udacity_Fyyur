...
paginate_questions Method takes a set of x-questions and returns a list,
containing 10 questions. Which questions are returned is decided by the
page parameter contained in the request.
...
def create_app(test_config=None):
  ...
  '''
    ...
    def getAllQuestionsPaginated():
        ...
        try:
            ...
            categories = {
                category.id: category.type for category in selection_cat}
  ...
  To distinguish between a creation of a new question and a search, the
  endpoint looks for the attribute 'searchTerm' inside the body of the POST
  request. If there is a 'searchTerm' attribute it performs a search if not
  it tries to create a new question with the given data.
    ...
    def createNewQuestion():
        ...
        if search is None:
            ...
            try:
                ...
                if abort_code is None:
                    current_search_result = paginate_questions(
    ...
    def getNextQuestion():
        ...
        try:
            ...
            question = Question.getRandomQuestion(
                last_questions, quiz_category['id'])
            if abort_code is None:
                return jsonify({
                    'success': True,
                    'question': question
